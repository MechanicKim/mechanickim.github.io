...
Docker Desktop의 무겁고 유료화된 환경을 대체할 수 있는 가장 강력한 오픈소스 대안
...
- Docker 명령어를 사용하기 위해 Docker CLI 설치 필요
- 이미 Docker Desktop이 설치되어 있다면, 충돌 방지를 위해 Docker Desktop을 완전히 종료하거나 삭제하는 것을 권장
...
시작할 때마다 옵션 입력이 번거롭다면 설정 파일을 직접 수정할 수 있다.
